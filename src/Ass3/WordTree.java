...
public class WordTree {
    ...
    public static void main(String[] args) {
        ...
        test.getRoot().getChild('d').createChild('e');
    ...
    WordTreeNode getPrefixNode(String word) {
        //   ADD YOUR CODE BELOW HERE
        WordTreeNode toReturn = root;
        for (int i = 0; i < word.length(); i++) {
            if (toReturn.getChild(word.charAt(i)) == null) {
                return toReturn;
            } else {
                toReturn = toReturn.getChild(word.charAt(i));
            }
        }

        return toReturn;  //  REPLACE THIS STUB
